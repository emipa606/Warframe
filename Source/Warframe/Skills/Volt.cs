...
namespace Warframe.Skills
{
    public static class Volt
    {
        ...
        public static Command_CastSkill Skill1()
        {
            ...
            ck.defaultLabel = "VoltSkill1.name".Translate();
            ck.icon = ContentFinder<Texture2D>.Get("Skills/VoltSkill1");
        ...
        public static Command_CastSkill Skill2()
        {
            ...
            ck.defaultLabel = "VoltSkill2.name".Translate();
            ck.icon = ContentFinder<Texture2D>.Get("Skills/VoltSkill2");
        ...
        {
            Command_CastSkillTargetingFloor ck = new Command_CastSkillTargetingFloor();
            ck.defaultLabel = "VoltSkill3.name".Translate();
            ck.icon = ContentFinder<Texture2D>.Get("Skills/VoltSkill3");
            ck.targetingParams = WarframeStaticMethods.jumpTP();
            ck.cooldownTime = 0.2f;
            ck.range = 2f;
        ...
        {
            Command_CastSkill ck = new Command_CastSkill();
            ck.defaultLabel = "VoltSkill4.name".Translate();
            ck.icon = ContentFinder<Texture2D>.Get("Skills/VoltSkill4");
            ck.targetingParams = WarframeStaticMethods.onlyPawn();
            ck.cooldownTime = 4f;
            ck.range = 16f;
